...
extern char problem_name[100];
extern int problem_count;
extern char *problems[];

typedef void (*test_problem)(double*, double*, int**, double*, double*);
...
void onthefly_display (population *pop, FILE *gp, long long ii);

int check_dominance (individual *a, individual *b);

void evaluate_pop (population *pop, test_problem problem_function);
void evaluate_ind (individual *ind, test_problem problem_function);
