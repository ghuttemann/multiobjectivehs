...
void report_pareto_front (population *pop, FILE *fpt, long long cur_msec, long long curgen)
{
    int i, j, count = 0;
    ...
    fprintf(fpt, "# Solutions: %d\n", count);
    fprintf(fpt, "# Timestamp: %lld\n", cur_msec);
    fprintf(fpt, "# Iterations: %lld\n", curgen);
